    ...
    try {
      ...
      const achievements = [
        ...
        },
        {
          ...
          icon_prompt: 'a cute 3D gold medal for a journeyman learner, clean background, shiny, award, intricate design',
          milestone_type: 'MODULE_COMPLETION',
          milestone_value: 10,
        },
        {
          ...
          icon_prompt: 'a cute 3D platinum trophy cup for a scholar, clean background, shiny, award, elegant design, gems',
          milestone_type: 'MODULE_COMPLETION',
          milestone_value: 25,
        },
      ];
